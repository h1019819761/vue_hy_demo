  ...
  <div class="goods">
    <div class="menu-wrapper" ref="left">
      <ul ref="leftUl">     <!--  current -->
        <li class="menu-item" @click="selecItem(index)" :class="{current:currentIndex===index}"
        ...
        <li class="food-list-hook" v-for="(good, index) in goods" :key="good.name" >
          ...
          <ul>
            <li class="food-item bottom-border-1px" v-for="(food, index) in good.foods"
             :key="food.name" @click.prevent="showFood(food)">
              <div class="icon">
  ...
  export default {
    ...
    computed:{
      ...
      currentIndex () {
        ...
        const index = tops.findIndex((top,index)=> (top<=scrollY && scrollY<tops[index+1]))
